"""Configuration module for HR Agentic Multi-Agent System (Enterprise Ready & Secrets Compliant)."""
import os
...
# FastMCP Endpoints and Authentication (Strict Environment / Secret Manager Binding)
